...
from_dir = "C:\Users\HP Pavilion\Desktop\negocios"
to_dir = "C:\Users\HP Pavilion\Desktop\TAREAS AMY\TAREAS\proyecto 102"
...
for file_name in list_of_files:
    ...
    if extension in ['.txt', '.pdf', '.doc', '.docx']:
        ...
        path2 = to_dir + '/' + "Archivos_Documentos"                     # Ejemplo path2 : D:/Mis archivos/Archivos_imagen      
        path3 = to_dir + '/' + "Archivos_Documentos" + '/' + file_name   # Ejemplo path3 : D:/Mis archivos/Archivo_Imagen/NombreImagen.jpg
        #print("path1 " , path1)
        #print("path3 ", path3)
